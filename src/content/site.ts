...
export const FAQ: FaqItem[] = [
  ...
  {
    q: "北科盒子需要付費嗎？",
    a: "完全免費，沒有任何訂閱或內購。下載、登入與使用所有功能都不需要付費。",
  },
  {
    q: "什麼是訪客模式？",
    a: "還沒拿到學號的準新生，或想先看看介面的同學，可以用訪客模式免登入體驗完整介面與操作；訪客模式下資料只存在你的裝置上。",
  },
  {
    q: "桌面小工具要怎麼設定？",
    a: "在 iPhone 主畫面或鎖定畫面長按空白處，點「+」搜尋「北科盒子」，選擇想要的尺寸即可。小工具會直接顯示當前與下一堂課。",
  },
  {
    q: "期末預選選課要怎麼操作？",
    a: "期末預選期間，在 App 內進入選課功能，加選本班與外班課程、拖曳排列志願順序後送出；送出後 App 會逐門回報選上與否。",
  },
  {
    q: "成績查詢能看到哪些資訊？",
    a: "各科成績、歷年 GPA 走勢圖、班級／分組／系所排名與 Top 百分比，一次看清楚。",
  },
  {
    q: "課表可以分享給同學嗎？",
    a: "可以。產生一條連結就能把課表分享給同學，對方一鍵匯入；也可以匯入別人分享的課表。",
  },
  {
    q: "排課系統和 App 有什麼不同？",
    a: "排課系統（course.ntutbox.com）是免登入的網頁版規劃器，適合選課前查課、排課表、偵測衝堂；App 登入後同步你的真實課表、成績，並在選課期間送出選課。兩者互補。",
  },
];
...
export const ABOUT = {
  ...
  paragraphs: [
    "一開始只是因為找不到好用的桌面課表小工具，決定自己寫一個同步課表的 App——結果越做越上頭，一路長成了現在整合課表、成績、選課與 60+ 校務服務的北科盒子。",
    "進北科之前，我在逢甲大學 iOS Club 擔任過幾屆幹部，對 iOS App 開發早有熱忱與實作經驗，也因此北科盒子從設計到功能都以 Apple 原生體驗為出發點。",
  ],
  highlights: ["Apple 原生開發", "北科在校生", "獨立開發與維護"],
};

/* ── 為什麼選北科盒子（首頁差異化區塊）──────────────────────────
   對比「學校官方 App」：只寫可驗證的功能事實，不用主觀貶義詞。 */
export const COMPARISON = {
  eyebrow: "為什麼選北科盒子",
  title: "原生整合，而不是另一個入口",
  intro:
    "北科盒子把常用的校務功能原生整合進 App，登入一次就能完成；而不是把每個功能都跳轉到外部網頁。",
  ntutboxLabel: "北科盒子",
  officialLabel: "學校官方 App",
  rows: [
    {
      label: "安裝",
      ntutbox: "App Store 上架，一鍵安裝、自動更新",
      official: "企業級 App，需手動安裝",
    },
    {
      label: "課表與成績",
      ntutbox: "登入後原生呈現，App 內直接查看",
      official: "跳轉外部網頁查看",
    },
    {
      label: "桌面小工具",
      ntutbox: "主畫面與鎖定畫面顯示課程",
      official: "無",
    },
    {
      label: "選課",
      ntutbox: "App 內排志願、送出、逐門回報",
      official: "跳轉選課網頁",
    },
  ],
  footnote: "以上對比基於實際使用體驗，僅供參考。",
};

/* ── 選課指南（/guide/selection）──────────────────────────────────
   只描述工具流程，不寫具體選課時程或校方規則（以學校公告為準）。 */
export const GUIDE = {
  metaTitle: "選課指南",
  metaDescription: "從選課前規劃到送出選課，用北科盒子與排課系統完成整個流程。",
  title: "選課指南",
  intro:
    "選課不只是「送出」那一下——從查課、排課表到送出後的確認，北科盒子與排課系統陪你走完每個階段。",
  steps: [
    {
      title: "選課前：先規劃好課表",
      body: "用排課系統（course.ntutbox.com）免登入查課：全文搜尋、多維篩選、衝堂偵測與學分統計，先把想修的課排成一份不衝堂的課表。",
    },
    {
      title: "選課期間：在 App 內送出",
      body: "期末預選期間，在 App 內加選本班與外班課程、拖曳排列志願順序後送出；送出後 App 會逐門回報選上與否。",
    },
    {
      title: "選課後：確認與同步",
